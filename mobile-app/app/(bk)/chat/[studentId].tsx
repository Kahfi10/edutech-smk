...
export default function BKChatScreen() {
  ...
  const openChat = async (student: any) => {
    ...
    try {
      ...
      // Buat/update room DULU, lalu baru subscribe
    ...
    return (
      <View style={styles.container}>
        <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
          ...
          <Text style={styles.headerSub}>Percakapan bersifat privat dan rahasia</Text>
        </View>
    ...
    >
      <View style={[styles.chatHeader, { paddingTop: insets.top + 8 }]}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.chatSub}>Konfidensial</Text>
        </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyChat}>
            <Ionicons name="lock-closed-outline" size={36} color={Colors.gray8} />
...
const styles = StyleSheet.create({
  ...
  bubbleMe:        { backgroundColor: Colors.gray1, borderBottomRightRadius: 4 },
