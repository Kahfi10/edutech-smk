...
const styles = StyleSheet.create({
  ...
  backText: { color: '#1C1C1E', fontWeight: '600', fontSize: 14 },
  ...
  fileLink: { fontSize: 12, color: '#1C1C1E', marginTop: 3 },
  gradeArea: { alignItems: 'flex-end', gap: 6 },
  gradeBtn: { backgroundColor: '#1C1C1E', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 6 },
